...
- [ ] **Step 1: Extend the bank-$06 configuration matrix**
...
- [ ] **Step 2: Add the pre-movement test**

Add a test that loops over 0x1B and 0x1C, creates an ACTIVE entity at (64,64), resolves a sword hit from (72,72), ticks once with sequence(0x01), and asserts position (61,61) and ignore-hits countdown 0x09. This proves the shared recoil runs before ZolGelMotion.advance.

- [ ] **Step 3: Add the blocked-step test**
...
- [ ] **Step 4: Add split cleanup assertions**
...
- [ ] **Step 1: Extend the existing predicate only**
...
- [ ] **Step 1: Update the existing Zol/Gel status**
